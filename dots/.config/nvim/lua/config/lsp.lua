...
vim.keymap.set("n", "<leader>E", ":TroubleToggle document_diagnostics<CR>", { silent = true, desc = "Set loclist" })
	...
	callback = function(ev)
		...
		if client.supports_method("textDocument/declaration") then
			vim.keymap.set(
				...
				{ buffer = bufnr, desc = "LSP Declaration of current symbol" }
			)
		end
		...
		if client.supports_method("textDocument/references") then
			vim.keymap.set(
				...
				{ buffer = bufnr, desc = "LSP References of current symbol" }
			)
		end
		...
		if client.supports_method("textDocument/rename") then
			vim.keymap.set(
				...
				"<leader>rn",
				vim.lsp.buf.rename,
				{ buffer = bufnr, desc = "LSP Rename current symbol" }
			)
		end
